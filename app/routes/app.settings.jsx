...
export default function SettingsPage() {
  ...
  useEffect(() => {
    if (fetcherData?.valid !== undefined) {
      setValidationResult(fetcherData);
    }
  }, [fetcherData]);
  ...
  const handleProviderChange = useCallback(
    (value) => {
      ...
      const defaultModel = DEFAULT_MODELS[value]?.[0]?.value;
  ...
  return (
    <Page
      title="Settings"
      subtitle="Configure your AI provider and FAQ generation preferences"
    ...
    >
      <BlockStack gap="500">
        ...
        {fetcherData?.error && !fetcherData.valid && !fetcherData.valid !== undefined ? null : (
          ...
          <Layout.Section>
            <BlockStack gap="400">
              ...
              <Card>
                <BlockStack gap="400">
                  ...
                  <Select
                    ...
                    helpText="Choose which AI service to use for generating FAQs"
                  />
                  ...
                  <Select
                    ...
                    value={model}
                    onChange={setModel}
                    helpText="Higher quality models produce better FAQs but cost more per request"
                  />
                  ...
                  <BlockStack gap="200">
                    ...
                    {validationResult && (
                      <InlineStack gap="200" blockAlign="center">
                        <Badge tone={validationResult.valid ? "success" : "critical"}>
                ...
                <BlockStack gap="400">
                  ...
                  <BlockStack gap="200">
                    <Text as="p" variant="bodyMd">
                      Number of FAQs to generate per product: <strong>{faqCount}</strong>
                    </Text>
                    <RangeSlider
                      label="FAQ Count"
                      labelHidden
                    ...
                    />
                    <Text as="p" variant="bodySm" tone="subdued">
                      We recommend 5–8 FAQs per product for best user experience
                    </Text>
                  </BlockStack>

                  <Checkbox
                    label="Auto-generate FAQs for new products"
                    checked={autoGenerate}
                    onChange={setAutoGenerate}
                    helpText="When enabled, FAQs will be automatically generated when new products are created (requires webhook setup)"
                  />
                </BlockStack>
              </Card>
              ...
              <Card>
                <BlockStack gap="400">
                  <Text as="h2" variant="headingMd">
                    Data Used for FAQ Generation
                  </Text>
                  <Divider />
                  <Text as="p" tone="subdued">
                    The AI uses all available product data to generate relevant questions:
                  </Text>
                  <BlockStack gap="200">
                    {[
                      ["✓", "Product title & description"],
                      ["✓", "Product type & vendor"],
                      ["✓", "All variants (price, SKU, weight, stock)"],
                      ["✓", "Product options (size, color, material, etc.)"],
                      ["✓", "All metafields"],
                      ["✓", "Product tags"],
                    ].map(([icon, label]) => (
                      <InlineStack key={label} gap="200" blockAlign="center">
                        <Text as="span" tone="success">{icon}</Text>
            ...
            <BlockStack gap="400">
              <Card>
                <BlockStack gap="300">
                  ...
                  <Text as="p" variant="bodySm" tone="subdued">
                    Costs vary based on product description length and FAQ count.
                  </Text>
                </BlockStack>
              </Card>
